...
import { ref, type Ref, watchEffect, watch, computed, onUnmounted } from 'vue'
import { bind, debounce, type DebouncedFunc } from 'lodash-es'
import { createPopper, type Instance } from "@popperjs/core";
import type { TooltipProps, TooltipEmits, TooltipInstance } from './types'
import { useClickOutside } from "@gene-design/hooks";
...
<template>
    <div class="g-tooltip" ref="containerNode" v-on="outerEvents">
        <div class="g-tooltip__trigger" ref="_triggerNode" v-on="events" v-if="!virtualTriggering">
            <slot></slot>
        </div>
        ...
        <transition :name="transition" @after-leave="destroyPopperInstance">
            <div class="g-tooltip__popper" ref="popperNode" v-on="dropdownEvents" v-if="visible"
                :class="`g-tooltip__popper--${props.size}`">
                <slot name="content">
                    {{ content }}
                </slot>
